...
public class Main <T>{
    ...
    public static void katalog(){
        String path = "src/ru/mirea/java2020/lab23";
    ...
    public static void main(String[] args) {
        ...
        Main<String> amm = new Main<String>();
        amm.conversion(arr);
        ...
        d[0]=21.3;
        d[1]=22.44;
        AnyType<Double> anyType = new AnyType<>();
        anyType.setArr(d);
        System.out.println(anyType.getElementIndex(1));
        katalog();
        Solution<Integer, Object> solution = new Solution<>();
        solution.newArraList(10, 29);
    }
}
